                ...
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="media align-items-center">
                    <div class="media-body ml-2 d-none d-lg-block">
                      <span class="mb-0 text-sm  font-weight-bold">{{ $adm->nama_adm }}</span>
                    </div>
                  </div>
                </a>
              </li>
        ...
        <div class="container-fluid mt--7">
          <div class="row">
                ...
                <div class="card-body pt-0 pt-md-4">
                    ...
                    <div class="col">
                      <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                        {{-- <div>
                          ...
                          <span class="description" style="text-transform: uppercase">{{ $adm->nama_kelas}}</span>
                        </div> --}}
                        {{--<div>
                  ...
                  {{--<div class="text-center">
                    ...
                    <div class="h5 font-weight-300" style="text-transform: capitalize;">
                      <i class="ni location_pin mr-2"></i>Bidang {{ $adm->nama_bidang }}
                    </div>
                    <div class="h5 mt-4" style="text-transform: capitalize;">
                      <i class="ni business_briefcase-24 mr-2" ></i>Kelas {{ $adm->nama_kelas }}
                    </div>
                    <div>
                      <i class="ni education_hat mr-2"></i>{{ $adm->no_hp }}
                    </div>
                    <hr class="my-4">
                    <p>{{ $adm->alamat }}</p>
                  </div>--}}
            ...
            <div class="col-xl-8 order-xl-1">
              <form action="/edit_adm" method="post">
                @csrf
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Masukkan Nama" disabled value="{{ $adm->nama_adm }}">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="input-email">Email</label>
                              <input type="email" name="email" id="input-email" class="form-control form-control-alternative" value="{{ $adm->email_adm }}" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="no_hp" name="no_hp" id="input-first-name" class="form-control form-control-alternative" placeholder="Masukkan No hp" value="{{ $adm->no_hp_adm }}">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="input-country" class="form-control form-control-alternative" placeholder="Masukkan Bidang" disabled value="{{ $adm->tgl_masuk_adm }}">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group focused">
                              ...
                              <textarea name="alamat" id="input-address" rows="5" cols="5" class="form-control form-control-alternative" placeholder="Masukkan Alamat" >{{ $adm->alamat_adm }}</textarea>
                            </div>
                          </div>
                        </div>
                      </div>

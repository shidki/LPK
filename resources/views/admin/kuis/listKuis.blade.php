...
<body>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-xl-10 col-sm-12">
                                                            <div class="checklist form-check font-size-15" >
                                                                <label class="form-check-label ms-1 task-title" for="customCheck1"><b>{{ $kuiss->nama }}</b></label>
                                                                
																<hr>
                                                                <div class="form-check-label ms-1 task-title" style="font-size: 15px;">Kuis : {{ $kuiss->judul_kuis}}</div>
                                                                <div style="display: flex; justify-content: space-between">
                                                                    ...
                                                                    <label class="form-check-label ms-1 task-title" for="customCheck1">
                                                                        @if ($kuiss->nilai_sementara == null)
                                                                            Nilai : {{ $kuiss->nilai_fix}}
                                                                        @else
                                                                            Nilai Sementara : {{ $kuiss->nilai_sementara}}
                                                                        @endif
                                                                    </label>
                                                                </div>
                                                            </div>
    ...
    <script>
          Swal.fire({
              title: "Gagal Mendownload Laporan",

                                ...
                                <div class="col-xl-12">
                                    <div class="task-list-box" id="landing-task">
                                        @foreach ($mapel as $mapels )
                                            ...
                                            {{--@if (isset($mapelStatus[$mapels->id_mapel]) && ($mapelStatus[$mapels->id_mapel] == 'belum_dipelajari' || $mapelStatus[$mapels->id_mapel] == 'progress'|| $mapelStatus[$mapels->id_mapel] == 'selesai'))
                                                <div style="cursor: pointer;" id="task-item-{{ $mapels->id_mapel }}" data-bs-toggle="modal" data-bs-target="#modalView-{{ $mapels->id_mapel }}">
                                                    <div class="card task-box rounded-3">
                                                        <div class="card-body">
                                                            <div class="row align-items-center">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-xl-7 col-md-6 col-sm-7">
                                                                            <div class="d-flex flex-wrap gap-3 mt-3 mt-xl-0 justify-content-md-end">
                                                                                ...
                                                                                @if (isset($mapelStatus[$mapels->id_mapel]) && $mapelStatus[$mapels->id_mapel] == 'progress')
                                                                                    <span class="badge rounded-pill badge-soft-warning font-size-11 task-status">Sedang Dipelajari</span>
                                                                                @elseif (isset($mapelStatus[$mapels->id_mapel]) && $mapelStatus[$mapels->id_mapel] == 'selesai')
                                                                                    <span class="badge rounded-pill badge-soft-success font-size-11 task-status">Selesai</span>
                                                                                @elseif (isset($mapelStatus[$mapels->id_mapel]) && $mapelStatus[$mapels->id_mapel] == 'locked')
                                                                                    <span class="badge rounded-pill badge-soft-danger font-size-11 task-status">Belum Dipelajari</span>
                                                                                @elseif (isset($mapelStatus[$mapels->id_mapel]) && $mapelStatus[$mapels->id_mapel] == 'belum_dipelajari')
                                                                                    <span class="badge rounded-pill badge-soft-danger font-size-11 task-status">Belum Dipelajari</span>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                            ...
                                            @else
                                                <div id="task-item-{{ $mapels->id_mapel }}" data-bs-toggle="modal">
                                                    <div class="card task-box rounded-3">
                                                        <div class="card-body">
                                                            <div class="row align-items-center">
                                                                <div class="col-xl-6 col-sm-5">

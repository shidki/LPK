                ...
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="media align-items-center">
                    <div class="media-body ml-2 d-none d-lg-block">
                      <span class="mb-0 text-sm  font-weight-bold">{{ $ins->nama_ins }}</span>
                    </div>
                  </div>
                </a>
              </li>
        ...
        <div class="container-fluid mt--7">
          <div class="row">
                ...
                <div class="card-body pt-0 pt-md-4">
                  <div class="row">
                    <div class="col">
                      <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                        {{-- <div>
                          <span class="heading">Kelas Mengajar</span>
                          <span class="description" style="text-transform: uppercase">{{ $ins->nama_kelas}}</span>
                        </div> --}}
                        {{--<div>
                  ...
                  {{--<div class="text-center">
                    ...
                    <div class="h5 font-weight-300" style="text-transform: capitalize;">
                      <i class="ni location_pin mr-2"></i>Bidang {{ $ins->nama_bidang }}
                    </div>
                    <div class="h5 mt-4" style="text-transform: capitalize;">
                      <i class="ni business_briefcase-24 mr-2" ></i>Kelas {{ $ins->nama_kelas }}
                    </div>
                    <div>
                      <i class="ni education_hat mr-2"></i>{{ $ins->no_hp }}
                    </div>
                    <hr class="my-4">
                    <p>{{ $ins->alamat }}</p>
                  </div>--}}
            ...
            <div class="col-xl-8 order-xl-1">
              <form action="/edit_ins" method="post">
                @csrf
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Masukkan Nama" disabled value="{{ $ins->nama_ins }}">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="input-email">Email</label>
                              <input type="email" name="email" id="input-email" class="form-control form-control-alternative" value="{{ $ins->email_ins }}" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="no_hp" name="no_hp" id="input-first-name" class="form-control form-control-alternative" placeholder="Masukkan No hp" value="{{ $ins->no_hp_ins }}">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group focused">
                              ...
                              <input id="input-address" name="alamat" class="form-control form-control-alternative" placeholder="Masukkan Alamat" value="{{ $ins->alamat_ins }}" type="text">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="form-group focused">
                              ...
                              <input type="text" id="input-city" class="form-control form-control-alternative" placeholder="Masukkan Kelas" disabled value="{{ $ins->nama_kelas }}">
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group focused">
                              <label class="form-control-label" for="input-country">Tanggal Masuk</label>
                              <input type="text" id="input-country" class="form-control form-control-alternative" placeholder="Masukkan Bidang" disabled value="{{ $ins->tgl_masuk_ins }}">
                            </div>
                          </div>
                        </div>
                      </div>
